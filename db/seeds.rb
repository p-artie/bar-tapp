...
lon = parse["location"]["lng"]
  ...
  @client = GooglePlaces::Client.new("AIzaSyDZXTCzH0s0nEwgcAlNom-O1bLGzB3V3o0", :radius => 500)
      ...
      Bar.all.each do |bar|
      	...
      	Drink.create(name: "Bloody Mary", description: "2-Tomato Juice\r\n1-Vodka", price: 0.65e1, image: "http://cdn.liquor.com/wp-content/uploads/2014/01/recipe-hopped-up-bloody-mary.jpg", bar_id: bar.id)
      	Drink.create(name: "Cuba Libre", description: "2-Coke\r\n1-Rum", price: 0.75e1, image: "http://shake-that.com/wp-content/uploads/2015/07/Cuba-Libre1-780x780.jpg", bar_id: bar.id)
      	Drink.create(name: "Tequila Sunrise", description: "2-Orange Juice\r\n1-Tequila", price: 0.55e1, image: "http://www.foodiecrush.com/wp-content/uploads/2015/09/Tequila-Sunrise-foodiecrush.com-020.jpg", bar_id: bar.id)
      	Drink.create(name: "Mojito", description: "2-Lime Juice\r\n1-Rum", price: 0.45e1, image: "http://cdn.liquor.com/wp-content/uploads/2010/09/herradura-tequila-mojito.jpg", bar_id: bar.id)
      	Drink.create(name: "Pina Colada", description: "2-Pineapple\r\n1-Rum\r\n1-Cream of Coconut", price: 0.55e1, image: "http://www.saveur.com/sites/saveur.com/files/styles/large_1x_/public/import/2014/images/2012-06/7-frozen-pina-colada-400.jpg?itok=zXZ2ExPX", bar_id: bar.id)
      	Drink.create(name: "Miami Vice", description: "2-Fruit\r\n1-Rum", price: 0.85e1, image: "http://cdn.shopify.com/s/files/1/1387/0585/products/Miami_Vice_grande.jpg?v=1471365702", bar_id: bar.id)
      	Drink.create(name: "CoronaRita", description: "2-Margerita\r\n1-Corona", price: 0.95e1, image: "https://pull01-kegworks.netdna-ssl.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/c/o/corona-rita-b1_1_1.jpg", bar_id: bar.id)
      	Drink.create(name: "Caipirinha", description: "2-Cachaca\r\n1-Lime", price: 0.95e1, image: "http://cdn3.foodviva.com/static-content/food-images/brazilian-drinks/caipirinha-cocktail/caipirinha-cocktail.jpg", bar_id: bar.id)
      end
